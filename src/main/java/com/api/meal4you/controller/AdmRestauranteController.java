...
public class AdmRestauranteController {
    ...
    public ResponseEntity<String> enviarCodigo(@Valid @RequestBody VerificaEmailRequestDTO dto) {
    ...
    public ResponseEntity<AdmRestauranteResponseDTO> atualizarEmail(@Valid @RequestBody AdmRestauranteRequestDTO dto) {
